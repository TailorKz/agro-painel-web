...
export function VisaoGeral() {
  ...
  const financeData = {
    ...
    porcentagemDedutivel: 74 // Para a barra de progresso
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between relative overflow-hidden">
          <div className="flex justify-between items-start">
            ...
            <button onClick={() => setShowValues(!showValues)} className="text-gray-400 hover:text-gray-600 transition-colors">
              {showValues ? <Eye size={20} /> : <EyeOff size={20} />}
            </button>
          </div>
          <div className="mt-4">
            <h2 className="text-3xl font-bold text-gray-800">
              {showValues ? financeData.saldo : 'R$ •••••••'}
            </h2>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h2 className="text-3xl font-bold text-emerald-600">
              {showValues ? financeData.entradas : 'R$ •••••••'}
            </h2>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h2 className="text-3xl font-bold text-rose-600">
              {showValues ? financeData.saidas : 'R$ •••••••'}
            </h2>
      ...
      {/* SEÇÃO INFERIOR: Livro Caixa e Últimas Notas */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        
        {/* DASHBOARD: DEDUTIBILIDADE (LCDPR) */}
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="w-full h-4 bg-rose-100 rounded-full overflow-hidden flex">
              <div 
                className="h-full bg-emerald-500 rounded-r-none transition-all duration-1000 ease-out"
                style={{ width: `${financeData.porcentagemDedutivel}%` }}
              />
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm font-semibold text-agro-secondary hover:text-agro-primary flex items-center gap-1 transition-colors">
              ...
              <div key={nota.id} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    nota.tipo === 'entrada' ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'
                  }`}>
                ...
                <div className={`font-bold text-sm ${
                  nota.tipo === 'entrada' ? 'text-emerald-600' : 'text-gray-700'
                }`}>
